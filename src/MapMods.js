export default{
    data:[
        ...
        {
            value: "Unique Boss deals X% increased Damage | Unique Boss has X% increased Attack and Cast Speed",
            id:24,
            regex:"eals",
            ranking: "None",
            selected: false
        ...
        {
            value:  "Monsters deal X% extra Physical Damage as Lighting",
            id:30,
            regex:"\"as l\"",
            ranking: "None",
            selected: false
        ...
        {
            value:"Monsters have 100% increased Area of Effect	",
            id: 57,
        ...
        {
            value:"Monsters have X% increased Critical Strike Chance | X% to Monster Critical Strike Multiplier",
            id: 58,
            regex:"\"ke c\"",
            ranking: "Bad",
            selected: false
        ...
        {
            value: "Players have X% reduced Chance to Block | Players have 30% less Armour",
            id: 69,
            regex:"loc",
            ranking: "None",
            selected: false
